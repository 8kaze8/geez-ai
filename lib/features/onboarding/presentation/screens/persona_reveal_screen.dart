...
class PersonaRevealScreen extends StatefulWidget {
  ...
  @override
  State<PersonaRevealScreen> createState() => _PersonaRevealScreenState();
}

class _PersonaRevealScreenState extends State<PersonaRevealScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final traits = widget.state.personaTraits;
    final personaName = widget.state.personaName;
